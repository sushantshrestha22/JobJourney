...
export default function Detail({company_name,job_name,location,description,salary,experience_level,skills,language,job_type}) {
  // useEffect(() => {
  //   axios
          ...
          JOB DETAILS
                    ...
                    <div className="  grid grid-cols-3 -2 px-[20px] pb-[20px] gap-y-[30px] gap-x-[10%]">
                      ...
                      <div className="flex flex-col justify-center ">
                        ...
                        <div className="text-lg"> vacancy</div>
                      </div>
                      <div className="flex flex-col justify-center ">
